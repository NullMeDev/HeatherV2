"""
MaxCure Foundation AUTH Gate - Uses MaxCure's Stripe integration
Creates Payment Method to validate card (no charge)
Site: https://maxcurefoundation.org
"""
...
STRIPE_PK = "pk_live_SMtnnvlq4TpJelMdklNha8iD"


def maxcure_auth_check(card_num: str, card_mon: str, card_yer: str, card_cvc: str,
                       proxy: dict = None) -> Tuple[str, bool]:
    """
    MaxCure AUTH check via Stripe Payment Method creation
...
if __name__ == "__main__":
    result, alive = maxcure_auth_check("4000000000000002", "12", "29", "123")
